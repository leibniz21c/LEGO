...
gdjs.RuntimeGamePixiRenderer.prototype._resizeCanvas = function() {
  ...
  this._pixiRenderer.view.style['top'] = 0;//this._marginTop + (maxHeight - canvasHeight) / 2 + 'px';
  this._pixiRenderer.view.style['left'] = 0;//this._marginLeft + (maxWidth - canvasWidth) / 2 + 'px';
